...
config_file.set("Other", "gemeenten-json-names-pararius", "gemeenten_names_pararius_lite.json")

config_file.set("Other", "gemeenten-json-links-pararius", "gemeenten_links_pararius_lite.json")
